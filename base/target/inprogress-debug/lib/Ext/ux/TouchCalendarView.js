...
Ext.define('Ext.ux.TouchCalendarView', {
    ...
    config: {
        ...
        baseTpl: [
                    '<div class="calendartuochBox">',
//                    '<div class="calendarYM">',
...
//                        '</thead>',
    ...
    applyViewMode: function(viewMode){
        ...
        this.setScrollable(viewMode.toUpperCase() === 'DAY' ? 'vertical' : null);
    ...
    onTimeSlotTap: function(e){
        ...
        this.getParent().fireEvent('selectiondatechange', newDate);
    },
