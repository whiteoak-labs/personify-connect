...
PushNotification.prototype.failure = function (msg) {
  console.log("PushNotification.js: Javascript Callback Error: " + msg)
}
...
PushNotification.prototype.call_native = function (callback, name, args) {
  ...
  'PushNotificationPlugin', // Tell cordova that we want to run "PushNotification"
...
PushNotification.prototype.setAlias = function (alias, callback) {
  console.log('PushNotification.setAlias: ' + alias);
...
PushNotification.prototype.takeOff = function (callback) {
  console.log("PushNotification.js: takeOff")
  this.call_native(callback, "takeOff");
}

PushNotification.prototype.setDevAppId = function (value, callback) {
  this.call_native(callback, "setDevAppId", [value]);value
}
PushNotification.prototype.setDevSecret = function (value, callback) {
  this.call_native(callback, "setDevSecret", [value]);
}
PushNotification.prototype.setProdAppId = function (value, callback) {
  this.call_native(callback, "setProdAppId", [value]);
}
PushNotification.prototype.setProdSecret = function (value, callback) {
  this.call_native(callback, "setProdSecret", [value]);
}
PushNotification.prototype.setUseProduction = function (value, callback) {
  var useProduction = value === 'Yes' || value === 'yes' || value === 'True' || value === 'true';
  console.log("PushNotification.js: setUseProduction: useProduction: " + useProduction)
  this.call_native(callback, "setUseProduction", [useProduction]);
}
