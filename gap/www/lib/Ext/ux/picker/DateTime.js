Ext.define('Ext.ux.picker.DateTime', {
    ...
    config: {
         ...
         * @accessor
         */
        dayText: (Ext.os.deviceType.toLowerCase() == "phone") ? 'D' : 'Day',
        ...
        */
         ...
         */
        minuteText: (Ext.os.deviceType.toLowerCase() == "phone") ? 'M' : 'Minute',
    ...
    getValue: function() {
        ...
        var yearval = (isNaN(values.year)) ? new Date().getFullYear() : values.year,
            ...
            if(values.ampm && values.ampm == "P" && hourval<12){
                hourval = hourval + 12;
            }
            if(values.ampm && values.ampm == "A" && hourval == 12){
                hourval = 0;
            }
    ...
    createSlot: function(name, days, months, years,hours,minutes,ampm) {
        switch (name) {
            case 'year':
                return {
                    name: 'year',
                    align: (Ext.os.deviceType.toLowerCase() == "phone") ? 'center' : 'center',
                    data: years,
                    title: this.getYearText(),
                    flex: (Ext.os.deviceType.toLowerCase() == "phone") ? 1.4 : 4
                };
            case 'month':
                return {
                    name: name,
                    ...
                    flex: (Ext.os.deviceType.toLowerCase() == "phone") ? 1.3 : 4
                };
            case 'day':
                return {
                    name: 'day',
            ...
            case 'ampm':
                return {
                    ...
                    flex: (Ext.os.deviceType.toLowerCase() == "phone") ? 0.8 : 2
                };
        }
    },
